...
HD_PWD='D:/Courses/CS_Cousrces/2024 Fall Digital Design/LabTest/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_1.tcl -notrace
