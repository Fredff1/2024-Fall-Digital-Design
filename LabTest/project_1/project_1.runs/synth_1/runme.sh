...
HD_PWD='D:/Courses/CS_Cousrces/2024 Fall Digital Design/LabTest/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_1.tcl
